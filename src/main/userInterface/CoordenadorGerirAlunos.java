 ...
 * @author pedro
 */
public class CoordenadorGerirAlunos extends javax.swing.JFrame {

    /**
     * Creates new form CoordenadorGerirAlunos
     */
    public CoordenadorGerirAlunos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoordenadorGerirAlunos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CoordenadorGerirAlunos().setVisible(true);
            }
        });
    }
